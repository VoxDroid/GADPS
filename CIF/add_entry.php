<?php
// add_entry.php for child_immunization
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $db = new SQLite3('../gender_dev_profiling.db');
    
    $stmt = $db->prepare("INSERT INTO child_immunization (name, age, birthdate, mother_name, bcg, hepa_b, penta_1, penta_2, penta_3, opv_1, opv_2, opv_3, pcv_1, pcv_2, pcv_3, ipv, mcv_1, mcv_2) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
<head>
    ...
    <title>Add New Entry - Child Immunization Form</title>
...
<body>
    ...
    <div class="container">
        <h1>Add New Entry - Child Immunization</h1>
        <form method="POST">
            ...
            <div class="immunization-grid">
                <div class="immunization-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="bcg" name="bcg">
                    </div>
                    <div class="form-group">
                        <label for="hepa_b">Hepatitis B:</label>
                        <input type="date" id="hepa_b" name="hepa_b">
                    </div>
                </div>
                <div class="immunization-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="penta_1" name="penta_1">
                    </div>
                    <div class="form-group">
                        <label for="penta_2">Penta 2:</label>
                        <input type="date" id="penta_2" name="penta_2">
                    </div>
                    <div class="form-group">
                        <label for="penta_3">Penta 3:</label>
                        <input type="date" id="penta_3" name="penta_3">
                    </div>
                </div>
                <div class="immunization-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="opv_1" name="opv_1">
                    </div>
                    <div class="form-group">
                        <label for="opv_2">OPV 2:</label>
                        <input type="date" id="opv_2" name="opv_2">
                    </div>
                    <div class="form-group">
                        <label for="opv_3">OPV 3:</label>
                        <input type="date" id="opv_3" name="opv_3">
                    </div>
                </div>
                <div class="immunization-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="pcv_1" name="pcv_1">
                    </div>
                    <div class="form-group">
                        <label for="pcv_2">PCV 2:</label>
                        <input type="date" id="pcv_2" name="pcv_2">
                    </div>
                    <div class="form-group">
                        <label for="pcv_3">PCV 3:</label>
                        <input type="date" id="pcv_3" name="pcv_3">
                    </div>
                </div>
                <div class="immunization-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="ipv" name="ipv">
                    </div>
                    <div class="form-group">
                        <label for="mcv_1">MCV 1:</label>
                        <input type="date" id="mcv_1" name="mcv_1">
                    </div>
                    <div class="form-group">
                        <label for="mcv_2">MCV 2:</label>
                        <input type="date" id="mcv_2" name="mcv_2">
                    </div>
                </div>
            </div>
