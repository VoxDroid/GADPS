...
$total_entries = $db->querySingle("SELECT COUNT(*) FROM barangay_midwifery WHERE item_status = 'inactive'" . $search_condition);

// Prepare the ORDER BY clause
$order_by = " ORDER BY $sort_column $sort_order";

// Get entries for current page
$query = "SELECT * FROM barangay_midwifery WHERE item_status = 'inactive'" . $search_condition . $order_by . " LIMIT $entries_per_page OFFSET $offset";
...
function restoreEntry($id) {
    global $db;
    $stmt = $db->prepare("UPDATE barangay_midwifery SET item_status = 'active' WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: bm_archive.php');
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Archived Entries - Barangay Midwifery Form</title>
...
<body>
    ...
    <div class="container">
        <h1>Archived Entries - Barangay Midwifery Form</h1>
        
        <div class="controls-container">
            <div class="button-container">
                <a href="barangay_midwifery.php" class="button"><i class="fas fa-arrow-left"></i> Back to Active Entries</a>
